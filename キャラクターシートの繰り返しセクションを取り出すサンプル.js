...
//
//■■注意■■
//Roll20のAPI内で呼び出すsendChatが_reporder_repeating_を参照しない現象を確認しています。
//(チャットから入力するのとAPIから呼び出すので挙動が異なる）
//現在フォーラムで問合せ中ですが、API内でsendChatを通して値を計算させたり取得させたりするときは、作成順で指定する必要がありそうです。
//■■■■■■■■
//
